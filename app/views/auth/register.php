...
<form method="POST" action="/Auth/register" class="space-y-4">
    <div>
        ...
        <div class="flex items-center bg-surface-container-low rounded-lg px-3 border border-outline-variant/30 focus-within:border-primary transition">
            ...
            <input type="text" name="username" required value="<?= htmlspecialchars($_POST['username'] ?? '') ?>"
                   class="inp text-sm w-full py-3 text-on-surface" placeholder="username">
        </div>
    </div>
    <div>
        ...
        <div class="flex items-center bg-surface-container-low rounded-lg px-3 border border-outline-variant/30 focus-within:border-primary transition">
            ...
            <input type="text" name="fullname" value="<?= htmlspecialchars($_POST['fullname'] ?? '') ?>"
                   class="inp text-sm w-full py-3 text-on-surface" placeholder="Nguyễn Văn A">
        </div>
    </div>
    <div>
    ...
    <div>
        ...
        <div class="flex items-center bg-surface-container-low rounded-lg px-3 border border-outline-variant/30 focus-within:border-primary transition">
            ...
            <input type="password" name="password" required class="inp text-sm w-full py-3 text-on-surface" placeholder="Tối thiểu 6 ký tự">
        </div>
    </div>
    <div>
        ...
        <div class="flex items-center bg-surface-container-low rounded-lg px-3 border border-outline-variant/30 focus-within:border-primary transition">
            ...
            <input type="password" name="confirm" required class="inp text-sm w-full py-3 text-on-surface" placeholder="••••••••">
        </div>
    </div>
